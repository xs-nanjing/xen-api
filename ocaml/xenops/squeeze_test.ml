...
let scenario_a = {
	...
	scenario_domains = [
		new idealised_vm_with_limit
			(domain_make 0 true 1000L 1500L 2000L 1500L 1500L 4L 0L) 100L 1250L;
		new intermittently_stuck_vm
			(domain_make 1 true 2500L 3500L 4500L 3500L 3500L 4L  0L) 500L 0.25;
	];
...
let scenario_b = {
	...
	scenario_domains = [
		new intermittently_stuck_vm
			(domain_make 1 true 500L 3500L 4500L 3500L 3500L 4L 0L) 100L 3.;
		new intermittently_stuck_vm
			(domain_make 0 true 500L 1500L 2500L 1500L 1500L 4L 0L) 100L 1.5;
	];
	host_free_mem_kib = 0L;
	required_mem_kib = 1000L;
	fistpoints = [ ];
...
let scenario_c = {
	...
	scenario_domains = [
		new idealised_vm (domain_make 0 true 1000L 1500L 2000L 1500L 1500L 0L 0L) 100L;
		new idealised_vm (domain_make 1 true 2000L 2500L 3000L 2500L 2500L 0L 0L) 100L;
	];
	host_free_mem_kib = 0L;
...
let scenario_d = {
	...
	scenario_domains = [
		new idealised_vm
			(domain_make 0 true 1000L 1500L 2000L 1500L 1500L 0L 0L) 100L;
		new idealised_vm_with_limit
			(domain_make 1 true 2000L 2500L 3000L 2500L 2500L 0L 0L) 100L 2250L;
	];
	host_free_mem_kib = 0L;
	required_mem_kib = 1000L;
	fistpoints = [ ];
...
let scenario_e = {
	...
	scenario_domains = [
		...
		new stuck_vm
			(domain_make 0 true (*min*)5000L (*target*)7000L (*max*)7000L (*actual*)7000L 7000L 0L 0L);
		(* The working domain is using less than it should be if the memory was freed and everything balanced *)
		new idealised_vm
			(domain_make 1 true (*min*)5000L (*target*)6000L (*max*)11000L (*actual*)6000L 6000L 0L 0L) 100L;
...
let scenario_h = {
	...
	scenario_domains = [
		new idealised_vm_with_upper_limit
			(domain_make 0 true 1000L 1500L 2000L 1500L 1500L 4L 0L) 100L 1500L;
		new idealised_vm
			(domain_make 1 true 1000L 1500L 2000L 1500L 1500L 4L 0L) 100L; (* this one can take up the slack *)
	];
